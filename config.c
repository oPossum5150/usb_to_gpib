...
// CONFIG1H
#pragma config FOSC = HSH       // Oscillator Selection
#pragma config PCLKEN = OFF     // Primary Oscillator Shutdown
...
#pragma config ICPRT = ON       // Dedicated In-Circuit Debug/Programming Port Enable
